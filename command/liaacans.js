...
module.exports = Doro = async (Doro, m, chatUpdate, store) => {
try {
...
var botNumber = await Doro.decodeJid(Doro.user.id)
...
var groupMetadata = m.isGroup ? await Doro.groupMetadata(m.chat).catch(e => {}) : ''
...
await Doro.setStatus(`${Doro.user.name} | Runtime : ${runtime(process.uptime())}`)
...
let gclink = (`https://chat.whatsapp.com/`+await Doro.groupInviteCode(m.chat))
...
Doro.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
}
}
...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, jpegThumbnail: global.thumb, surface: 200, message: '©Created By Doro BOT', orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: '©Doro',jpegThumbnail: global.thumb}}}
...
userJid: Doro.user.id,
quoted: m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, Doro.user.id)
...
Doro.ev.emit('messages.upsert', msg)
}
...
Doro.sendText(m.chat, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+m.chat].pesan = mesg }).catch(_ => _)
...
await Doro.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await Doro.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await Doro.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await Doro.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n*${deskripsi}*\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await Doro.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await Doro.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await Doro.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (room.x !== room.o) await Doro.sendText(room.x, str, m, { mentions: parseMention(str) } )
await Doro.sendText(room.o, str, m, { mentions: parseMention(str) } )
if (isTie || isWin) {
...
Doro.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
Doro.sendText(m.chat, `Suit telah dikirimkan ke chat
...
if (!roof.pilih) Doro.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
if (!roof.pilih2) Doro.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) Doro.sendText(m.chat, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
Doro.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
if (!roof.pilih2) Doro.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
m.reply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) Doro.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
...
Doro.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
async function payment(jid, from, msg = { conversation: "Test" }, currency = "IDR", value = 5000) {
  ...
  await Doro.relayMessage(jid, { requestPaymentMessage: paymentTest }, {}) 
  return paymentTest
}
...
Doro.updateBlockStatus(m.sender, 'block')
}
...
if (command) {
console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32m Doro \x1b[1;37m]', time, chalk.green(budy || m.mtype), 'Dari', chalk.blue(pushname), 'Di', chalk.yellow(groupName ? groupName : 'Private Chat' ), 'args :', chalk.white(args.length))
}
//━━━━━━━━━━━━━━━[ FITURNYA ]━━━━━━━━━━━━━━━━━//
...
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, allmenu, creator, m, { quoted: kafloc })
            }
         break
...
let menunyaa = `Menampilkan List Menu Doro Bot
...
const listMessage = {
  text: menunyaa,
  footer: "© Created By Doro BOT",
  title: "━━━[ LIST Doro MENU ]━━━",
  buttonText: "Klik Disini",
  sections
}
const tessgh = await Doro.sendMessage(m.chat, listMessage, { quoted: kafloc })
}
break
case 'funmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, funmenu, creator, m, { quoted: kafloc })
            }
            break
case 'groupmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, group, creator, m, { quoted: kafloc })
            }
            break
case 'convertmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, convermenu, creator, m, { quoted: kafloc })
            }
            break
case 'randommenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, rm, creator, m, { quoted: kafloc })
            }
            break
case 'downloadmenu': {
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, downloadme, creator, m, { quoted: kafloc })
            }
            break
case 'ownermenu': {
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, ownerme, creator, m, { quoted: kafloc })
            }
            break
case 'anonymousmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, cht, creator, m, { quoted: kafloc })
            }
            break
case 'databasemenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, dbm, creator, m, { quoted: kafloc })
            }
            break
case 'islamicmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Owner' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, islmm, creator, m, { quoted: kafloc })
            }
            break
case 'chargermenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, chargermenu, creator, m, { quoted: kafloc })
            }
            break
case 'makermenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, mkrmnu, creator, m, { quoted: kafloc })
            }
            break
case 'bugmenu': {
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, bug, creator, m, { quoted: kafloc })
            }
            break
case 'donasi': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
donasi = `*「 🐰DONASI BY Doro🐰 」*
...
await Doro.sendButtonText(m.chat, buttons, donasi, creator, m, { quoted: kafloc })
}
break
case 'mainmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, mainmenu, creator, m, { quoted: kafloc })
            }
break
...
Tiktok : https://tiktok.com/@Doro'

❖ Link Base Script ❖
https://github.com/Doro/base-device
...
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️Back Menu' }, type: 1 },{ buttonId: 'ping', buttonText: { displayText: 'Status Bot' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Owner' }, type: 1 }]
            await Doro.sendButtonText(m.chat, buttons, source, creator, m, { quoted: kafloc })
            }
break
case 'revoke': {
  ...
  await Doro.groupRevokeInvite(m.chat)
...
await Doro.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => m.reply(`Sukses Kick Member Tidak Berguna`))
}
break
case 'add': {
if (!m.isGroup) throw mess.group
...
await Doro.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => m.reply(`Sukses Add Member Berguna`))
}
break
case 'promote': {
if (!m.isGroup) throw mess.group
...
if (!isAdmins) throw mess.admin
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Doro.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => m.reply(`Sukses Member Sebagai Admin`))
}
break
case 'demote': {
if (!m.isGroup) throw mess.group
...
if (!isAdmins) throw mess.admin
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Doro.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => m.reply(`Sukses Admin Sebagai Member`))
}
break
...
await Doro.groupUpdateSubject(m.chat, text).then((res) => m.reply(`Sukses Setname Grup Ini!`))
}
break
...
if (!isAdmins) throw mess.admin
if (!text) throw 'Teks Nya Mana Bos ?'
await Doro.groupUpdateDescription(m.chat, text).then((res) => m.reply(`Sukses Setdesc Grup Ini`))
}
break
...
let media = await Doro.downloadAndSaveMediaMessage(quoted)
await Doro.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
...
Doro.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: fkontak })
}
break
case 'hidetag': {
if (!m.isGroup) throw mess.group
if (!isBotAdmins) throw mess.botAdmin
if (!isAdmins) throw mess.admin
Doro.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: fkontak })
}
...
Doro.sendMessage(m.chat, buttonMessageVote)
}
break
case 'upvote': {
if (!m.isGroup) throw mess.group
...
Doro.sendMessage(m.chat, buttonMessageUpvote)
}
break
case 'devote': {
if (!m.isGroup) throw mess.group
...
Doro.sendMessage(m.chat, buttonMessageDevote)
}
break
case 'cekvote':
if (!m.isGroup) throw mess.group
...
©${Doro.user.id}
`
Doro.sendTextWithMentions(m.chat, teks_vote, m)
break
...
if (!isAdmins) throw mess.admin
if (args[0] === 'close'){
await Doro.groupSettingUpdate(m.chat, 'announcement').then((res) => m.reply(`Sukses Menutup Group`)).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'open'){
await Doro.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m.reply(`Sukses Membuka Group`))
} else {
let buttons = [
{ buttonId: 'group open', buttonText: { displayText: 'OPEN' }, type: 1 },
{ buttonId: 'group close', buttonText: { displayText: 'CLOSE' }, type: 1 }
]
await Doro.sendButtonText(m.chat, buttons, `Mode Group`, creator, m)
}
}
break
case 'editinfo': {
...
if (!isAdmins) throw mess.admin
if (args[0] === 'open'){
await Doro.groupSettingUpdate(m.chat, 'unlocked').then((res) => m.reply(`Sukses Membuka Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'close'){
await Doro.groupSettingUpdate(m.chat, 'locked').then((res) => m.reply(`Sukses Menutup Edit Info Group`))
} else {
let buttons = [
{ buttonId: 'editinfo open', buttonText: { displayText: 'OPEN' }, type: 1 },
{ buttonId: 'editinfo close', buttonText: { displayText: 'CLOSE' }, type: 1 }
]
await Doro.sendButtonText(m.chat, buttons, `Mode Edit Info`, creator, m)
}
}
break
case 'antilink': {
...
await Doro.sendButtonText(m.chat, buttons, `Mode Antilink`, creator, m)
}
}
break
case 'antilinkig': {
...
await Doro.sendButtonText(m.chat, buttons, `Mode Antilink Insta`, creator, m)
}
}
break
case 'antiviewonce': {
...
await Doro.sendButtonText(m.chat, buttons, `Mode Antiviewonce`, creator, m)
}
}
break
case 'antiwame': {
...
await Doro.sendButtonText(m.chat, buttons, `Mode Antiwame`, creator, m)
}
}
break
case 'mute': {
...
m.reply(`${Doro.user.name} telah di mute di group ini !`)
} else if (args[0] === "off") {
if (!db.data.chats[m.chat].mute) return m.reply(`Sudah Tidak Aktif Sebelumnya`)
db.data.chats[m.chat].mute = false
m.reply(`${Doro.user.name} telah di unmute di group ini !`)
} else {
let buttons = [
{ buttonId: 'mute on', buttonText: { displayText: 'ON' }, type: 1 },
{ buttonId: 'mute off', buttonText: { displayText: 'OFF' }, type: 1 }
]
await Doro.sendButtonText(m.chat, buttons, `Mute Bot`, creator, m)
}
}
break
case 'linkgroup': case 'linkgc': {
if (!m.isGroup) throw mess.group
let response = await Doro.groupInviteCode(m.chat)
Doro.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
case 'ephemeral': {
if (!m.isGroup) throw mess.group
...
if (args[0] === 'enable') {
await Doro.sendMessage(m.chat, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL }).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'disable') {
await Doro.sendMessage(m.chat, { disappearingMessagesInChat: false }).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
}
break
case 'ffcover': case 'crossfire': case 'galaxy': case 'glass': case 'neon': case 'beach': case 'igcertificate': case 'ytcertificate': {
                ...
                m.reply(mess.wait)
                Doro.sendMessage(m.chat, { image: { url: api('Doro', '/ephoto/' + command, { text: text }, 'apikey') }, caption: `Ephoto ${command}` }, { quoted: m })
            }
            break
case 'blackpink': {
      if (!text) throw 'No Query Text'
                m.reply(mess.wait)
                Doro.sendMessage(m.chat, { image: { url:  fetchJson('https://restapi-Doro.herokuapp.com/api/textpro/black-pink?text=Revita&apikey=APIKEY') }, caption: `Ephoto ${command}` }, { quoted: m })
            }
            break
case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
                ...
                Doro.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
...
`.trim()
                Doro.sendText(m.chat, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
            }
            break
            case 'lockcmd': {
                if (!isCreator) throw mess.owner
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            case 'getmsg': {
                ...
                Doro.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
            case 'listmsg': {
...
case 'anonymous': {
		...
		let buttons = [
                ...
                Doro.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await Doro.getName(m.sender)} Welcome To Anonymous Chat\n\nKlik Button Dibawah Ini Untuk Mencari Partner\`\`\``, Doro.user.name, m)
            }
	    break
	    case 'keluar': {
                if (m.isGroup) return m.reply('Fitur Tidak Dapat Digunakan Untuk Group!')
                ...
                if (!room) {
                    ...
                    await Doro.sendButtonText(m.chat, buttons, `\`\`\`Kamu Sedang Tidak Berada Di Sesi Anonymous, Tekan Button Untuk Mencari Partner \`\`\``)
                    throw false
                }
                m.reply('Ok')
                let other = room.other(m.sender)
                if (other) await Doro.sendText(other, `\`\`\`Partner Telah Meninggalkan Sesi Anonymous\`\`\``, m)
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await Doro.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, Doro.user.name, m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await Doro.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, Doro.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await Doro.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, Doro.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await Doro.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, Doro.user.name, m)
                }
                break
            }
...
await Doro.sendButtonText(m.chat, buttons, jawab, creator, m, {mentions: menst})
}
break
case 'jodohku': {
if (!m.isGroup) throw mess.group
...
await Doro.sendButtonText(m.chat, buttons, jawab, creator, m, {mentions: ments})
}
break
case 'gbtku': {
            ...
            await Doro.sendButtonText(m.chat, buttons, jawab, `${text.split("|")[1]}`, m)
            }
            break
            case 'bisakah': {
            ...
            await Doro.sendButtonText(m.chat, buttons, jawab, creator, m)
            }
            break
            case 'apakah': {
...
if (this.game) {
delete this.game
Doro.sendText(m.chat, `Berhasil delete session TicTacToe`, m)
} else if (!this.game) {
...
case 'couple': {
                ...
                Doro.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male` }, { quoted: fkontak })
                Doro.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female` }, { quoted: fkontak })
            }
        break
case 'family100': {
...
id: 'family100'+m.chat,
pesan: await Doro.sendText(m.chat, hasil, m),
...random,
...
let msg = await Doro.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: fkontak })
Doro.sendText(m.chat, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Jawaban: " + result.jawaban)
Doro.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, Doro.user.name, m)
delete tebaklagu[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
Doro.sendImage(m.chat, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Jawaban: " + result.jawaban)
Doro.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, Doro.user.name, m)
delete tebakgambar[m.sender.split('@')[0]]
}
} else if (args[0] === 'kata') {
...
let result = anu[Math.floor(Math.random() * anu.length)]
Doro.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Jawaban: " + result.jawaban)
Doro.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, Doro.user.name, m)
delete tebakkata[m.sender.split('@')[0]]
}
...
console.log("Jawaban: " + result.jawaban)
Doro.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, Doro.user.name, m)
delete tebakkalimat[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
Doro.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Jawaban: " + result.jawaban)
Doro.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, Doro.user.name, m)
delete tebaklirik[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
Doro.sendText(m.chat, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
...
console.log("Jawaban: " + result.jawaban)
Doro.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, Doro.user.name, m)
delete caklontong[m.sender.split('@')[0]]
delete caklontong_desk[m.sender.split('@')[0]]
}
}
...
Doro.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
this.suit[id] = {
chat: await Doro.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) Doro.sendText(m.chat, `_Waktu suit habis_`, m)
delete this.suit[id]
...
+ `END:VCARD`
let msg = await Doro.sendMessage(m.chat, { contacts: { displayName: `${owner}`, contacts: [{ vcard }] } }, { quoted: fkontak })
let buttons3 = [
...
Doro.sendMessage(m.chat, buttonMessage3, { quoted: fkontak })                        
}
break
...
Doro.sendMessage(m.chat, { image: buffer }, { quoted: fkontak })
fs.unlinkSync(ran)
})
}
break
...
m.reply(mess.wait)
arg = args.join(' ')
mee = await Doro.downloadAndSaveMediaMessage(quoted)
const { TelegraPh } = require('../message/uploader')
mem = await TelegraPh(mee)
meme = `https://api.memegen.link/images/custom/-/${arg}.png?background=${mem}`
memek = await Doro.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
...
let encmedia = await Doro.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await Doro.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
case 'stickerwm': case 'swm': case 'stickergifwm': case 'sgifwm': {
        	...
        	m.reply(mess.wait)
                if (/image/.test(mime)) {
                    let media = await Doro.downloadMediaMessage(quoted)
                    let encmedia = await Doro.sendImageAsSticker(m.chat, media, m, { packname: teks1, author: teks2 })
                    await fs.unlinkSync(encmedia)
                } else if (/video/.test(mime)) {
                    if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
                    let media = await Doro.downloadMediaMessage(quoted)
                    let encmedia = await Doro.sendVideoAsSticker(m.chat, media, m, { packname: teks1, author: teks2 })
                    await fs.unlinkSync(encmedia)
                } else {
                    throw `Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`
                }
...
case 'emojimix': {
	...
	for (let res of anu.results) {
	    let encmedia = await Doro.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
	    await fs.unlinkSync(encmedia)
	}
        }
        break
...
Doro.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${Doro.user.name}.mp3`}, { quoted: fkontak })
}
break
...
await Doro.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: fkontak })
...
case 'pinterest': {
  ...
  Doro.sendMessage(m.chat, { image: { url: result }, caption: 'Source Url : '+result, buttons: buttonspinterest }, { quoted: fkontak })
  }
  break
case 'wallpaper': {
  if (!text) return m.reply(`Mau Cari Apa Di ${command}?\nExample : *${prefix + command} hinata*`)
  ...
  Doro.sendMessage(m.chat, { image: { url: result.image[0] }, caption: `Source Url : ${result.image[2] || result.image[1] || result.image[0]}`, buttons: buttonswallpaper }, { quoted: fkontak })
  }
  break
case 'quotesanime': {
  m.reply(mess.wait)
  ...
  Doro.sendButtonText(m.chat, buttonsquotes, `${result.quotes}\n\nBy : ${result.karakter}`, global.ownerName, m)
  }
  break
case 'wikimedia': {
...
🔗 Media Url : ${result.image}`,
  ...
  Doro.sendMessage(m.chat, buttonMessage, { quoted: fkontak })
  }
  break
//Downloader
...
📮 Resolusi : ${args[1] || '360p'}`
  Doro.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: caption }, { quoted: m })
  }
  break
case 'iqra': {
		...
		Doro.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		/**case 'juzamma': {
		if (args[0] === 'pdf') {
		m.reply(mess.wait)
		Doro.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:m})
		} else if (args[0] === 'docx') {
		m.reply(mess.wait)
		Doro.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:m})
		} else if (args[0] === 'pptx') {
		m.reply(mess.wait)
		Doro.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:m})
		} else if (args[0] === 'xlsx') {
		m.reply(mess.wait)
		Doro.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:m})
		} else {
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		m.reply(txt)
		Doro.sendMessage(m.chat, {audio: { url: res.result.data.audio.primary }, mimetype: 'audio/mpeg'}, { quoted : m })
		}
		break
		case 'tafsirsurah': {
...
📮 Resolusi : ${args[1] || '128kbps'}`
  Doro.sendImage(m.chat, media.thumb, caption, m)
  Doro.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: fkontak })
  }
  break
...
🔗 Url : ${i.url}\n\n─────────────────\n\n`
  ...
  Doro.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: fkontak })
  }
  break
case 'play':
  if (!isPremium) throw mess.prem
...
case 'tiktokmp3': case 'tiktokaudio': {
                ...
                let msg = await Doro.sendMessage(m.chat, buttonMessage, { quoted: m })
                Doro.sendMessage(m.chat, { audio: { url: anu.result.nowm }, mimetype: 'audio/mpeg'}, { quoted: fkontak })
            }
            break
	        ...
	        if (!isPremium) throw mess.prem
                ...
                if (/(?:\/p\/|\/reel\/|\/tv\/)([^\s&]+)/.test(isUrl(text)[0])) {
                    let anu = await fetchJson(api('Doro', '/downloader/instagram2', { url: isUrl(text)[0] }, 'apikey'))
                    for (let media of anu.data) Doro.sendFileUrl(m.chat, media, `Download Url Instagram From ${isUrl(text)[0]}`, m)
                } else if (/\/stories\/([^\s&]+)/.test(isUrl(text)[0])) {
                    let anu = await fetchJson('https://restapi-Doro.herokuapp.com/api/download/tiktok2?url=https://vt.tiktok.com/ZSeJ7P56G&apikey=APIKEY')
                    Doro.sendFileUrl(m.chat, anu.media[0].url, `Download Url Instagram From ${isUrl(text)[0]}`, m)
                }
            }
            break
            case 'joox': case 'jooxdl': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(api('Doro', '/downloader/joox', { query: text }, 'apikey'))
                let msg = await Doro.sendImage(m.chat, anu.result.img, `⭔ Title : ${anu.result.lagu}\n⭔ Album : ${anu.result.album}\n⭔ Singer : ${anu.result.penyanyi}\n⭔ Publish : ${anu.result.publish}\n⭔ Lirik :\n${anu.result.lirik.result}`, m)
                Doro.sendMessage(m.chat, { audio: { url: anu.result.mp4aLink }, mimetype: 'audio/mpeg', fileName: anu.result.lagu+'.m4a' }, { quoted: msg })
            }
            break
            case 'soundcloud': case 'scdl': {
                ...
                if (!text) throw 'No Query Title'
                m.reply(mess.wait)
                let anu = await fetchJson(api('Doro', '/downloader/soundcloud', { url: isUrl(text)[0] }, 'apikey'))
                let msg = await Doro.sendImage(m.chat, anu.result.thumb, `⭔ Title : ${anu.result.title}\n⭔ Url : ${isUrl(text)[0]}`)
                DorosendMessage(m.chat, { audio: { url: anu.result.url }, mimetype: 'audio/mpeg', fileName: anu.result.title+'.m4a' }, { quoted: fkontak })
            }
            break
	        ...
	        if (!isPremium) throw mess.prem
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(api('Doro', '/api/downloader/twitter', { url: text }, 'apikey'))
                let buttons = [
		    ...
		    image: { url: anu.result.thumb },
                ...
                let msg = await Doro.sendMessage(m.chat, buttonMessage, { quoted: m })
                Doro.sendMessage(m.chat, { audio: { url: anu.result.audio } }, { quoted: fkontak })
            }
            break
	        ...
	        if (!isPremium) throw mess.prem
                ...
                Doro.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `⭔ Title : ${anu.result.title}`}, { quoted: fkontak })
            }
            break
	        ...
	        if (!isPremium) throw mess.prem
                ...
                Doro.sendMessage(m.chat, { video: { url: anu.result }, caption: `Download From ${text}` }, { quoted: fkontak })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        Doro.sendMessage(m.chat, { image: { url }, caption: `⭔ Title : ${anu.title}\n⭔ Author : ${anu.author.name}\n⭔ Like : ${anu.like}\n⭔ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
await Doro.groupAcceptInvite(result)
m.reply(`Sukses`)
}
break
case 'leave': {
...
await Doro.groupLeave(m.chat)
}
break
case 'block': {
if (!isCreator) throw mess.owner
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Doro.updateBlockStatus(users, 'block')
...
if (!isCreator) throw mess.owner
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await Doro.updateBlockStatus(users, 'unblock')
...
case 'delete': case 'del': {
                ...
                Doro.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
            }
            break
case 'menfes': case 'menfess': { 
            ...
            await Doro.sendButtonText(m1 + '@s.whatsapp.net', buttons, pjtxt, kawk, m, {mentions: ments, quoted: kafloc})
            let akhji = `Pesan Telah Terkirim\nKe @${mq1.split('@')[0]}`
            await Doro.sendButtonText(m.chat, buttons, akhji, creator, m, {mentions: ments, quoted: kafloc})
            }
            break
case 'menfessconfirm':
		 Doro.sendMessage(q, {text: `Sudah Di Confirmasi Nih Menfess nyaa🤭`})
...
Doro.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: doc })
}
break
case 'poll': {
if (!m.isGroup) throw mess.group
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM BROTHER BY Doro BOT"
	}
],
"selectableOptionsCount": 5
	}
}), { userJid: m.chat, quoted: doc })
Doro.relayMessage(m.chat, pollCreation.message, { messageId: pollCreation.key.id })
...
Doro.relayMessage(m.chat, order.message, { messageId: order.key.id })
}
break
case 'santetdia': {
if (!m.isGroup) throw mess.group
...
anjay(`Baiklah Tuan`)
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./image/thumbnail.jpg') }, { upload: Doro.waUploadToServer })
...
Doro.relayMessage(num, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}
...
Doro.relayMessage(m.chat, document.message, { messageId: document.key.id })
}
break
case 'duc': {
if (!m.isGroup) throw mess.group
...
Doro.relayMessage(m.chat, audio.message, { messageId: audio.key.id })
}
break
case 'bug2': {
if (!m.isGroup) throw mess.group
...
Doro.relayMessage(m.chat, image.message, { messageId: image.key.id })
}
break
case 'bug3': {
if (!m.isGroup) throw mess.group
...
Doro.relayMessage(m.chat, extended.message, { messageId: extended.key.id })
}
break
case 'bug5': {
if (!m.isGroup) throw mess.group
...
Doro.relayMessage(m.chat, sticker.message, { messageId: sticker.key.id })
}
break
case 'bug6': {
if (!m.isGroup) throw mess.group
...
var extended = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"extendedTextMessage": {
"text": "https://wa.me/6281393936306",
"matchedText": "https://wa.me/6281393936306",
...
Doro.relayMessage(m.chat, contact.message, { messageId: contact.key.id })
}
break
case 'lokas': {
if (!m.isGroup) throw mess.group
...
Doro.relayMessage(m.chat, liveLocation.message, { messageId: liveLocation.key.id })
}
break
case 'buglokas': {
if (!m.isGroup) throw mess.group
...
Doro.relayMessage(m.chat, location.message, { messageId: location.key.id })
}
break
case 'buginvite': {
if (!m.isGroup) throw mess.group
...
Doro.relayMessage(m.chat, groupInvite.message, { messageId: groupInvite.key.id })
}
break
case 'troli': {
if (!m.isGroup) throw mess.group
...
Doro.relayMessage(m.chat, catalog.message, { messageId: catalog.key.id })
}
break
...
Doro.relayMessage(num, catalog.message, { messageId: catalog.key.id })
}
...
a = await Doro.sendMessage(m.chat, {react: { text: " ️", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
Doro.sendMessage(Pe, {text: "Xd"}, {quoted: doc})
await sleep(20)
Doro.sendMessage(Pe, {text: "Xd"}, {quoted: doc})
await sleep(20)
Doro.sendMessage(Pe, {text: "Xd"}, {quoted: doc})
...
ydd = `Hallo Aku Doro`
for (let i = 0; i < jumlah; i++) {
Doro.sendMessage(m.chat, {sticker: global.thumb},{quoted: {
key: { 
fromMe: false, 
participant: `0@s.whatsapp.net`, 
...({ remoteJid: "" }) 
...
ydd = `Hallo Aku Doro`
for (let i = 0; i < jumlah; i++) {
Doro.sendMessage(m.chat, {document: global.thumb},{quoted: {
key: {
fromMe: false, 
...
if (!isCreator) throw mess.owner
if (!m.isGroup) throw mess.group
Doro.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: doc })
}
break
case 'runtime': {
            	let lowq = `*Bot Telah Online Selama*\n*${runtime(process.uptime())}*`
                let buttons = [{ buttonId: 'donasi', buttonText: { displayText: 'SEWA' }, type: 1 }]
                await Doro.sendButtonText(m.chat, buttons, lowq, creator, m, { quoted: fkontak })
                }
            break
case 'setppbot': {
                if (!isCreator) throw mess.owner
                ...
                if (/webp/.test(mime)) throw `Kirim/Reply Image Dengan Caption ${prefix + command}`
                let media = await Doro.downloadAndSaveMediaMessage(quoted)
                await Doro.updateProfilePicture(botNumber, { url: media }).catch((err) => fs.unlinkSync(media))
                m.reply(mess.success)
                }
                break
case 'listonline': case 'liston': {
            if (!isCreator) throw mess.owner
                    ...
                    Doro.sendText(m.chat, 'List Online:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
case 'listpc': {
      if (!isCreator) throw mess.owner
                 ...
                 Doro.sendTextWithMentions(m.chat, teks, m)
             }
             break
                case 'listgc': {
                if (!isCreator) throw mess.owner
                 ...
                 for (let i of anu) {
                     let metadata = await Doro.groupMetadata(i)
...
if(!isPremium) throw mess.prem
jadibot(Doro, m, m.chat)
}
break
case 'listjadibot':
if (!isPremium) throw mess.prem
try {
let user = [... new Set([...global.conns.filter(Doro => Doro.user).map(Doro => Doro.user)])]
te = "*List Jadibot*\n\n"
for (let i of user){
let y = await Doro.decodeJid(i.id)
te += " × User : @" + y.split("@")[0] + "\n"
te += " × Name : " + i.name + "\n\n"
}
Doro.sendMessage(m.chat,{text:te,mentions: [y], },{quoted:m})
} catch (err) {
...
topup = `*｢  TOPUP MENU OTOMATIS  ｣*
  ...
  *｢ JASA SUNTIK SOSMED ｣*
  ...
  ● ${prefix}prichlist`
 let buttons = [{ buttonId: 'menu', buttonText: { displayText: 'Menu' }, type: 1 }]
Doro.sendButtonText(m.chat, buttons, topup, creator)
}
break 
case 'tts':
let eng = text.split("|")[0]
let cap = text.split("|")[1]
  if (!q.includes("@")) return Doro.sendMessage(m.chat, `ᴇxᴀᴍᴘʟᴇ: ${prefix}ᴇɴ|ʜᴇʟʟᴏ`, text, {quoted: m})
 var dtt = `${cap}`
  m.reply(mess.wait)
  var ranm = getRandom('.mp3')
		var	rano = getRandom('.ogg')
         ...
         gtts.save(ranm, dtt, function() {
          ...
          Doro.sendMessage(m.chat, { audio: buffer, mimetype: 'audio/mp4', ptt: true})
          fs.unlinkSync(rano)
          })
          })
  break
...
const tessgh = await Doro.sendMessage(m.chat, listMessage)
break
}
case 'ovo':{
if (m.isGroup) return m.reply('Fitur Ini Hanya Bisa Digunakan Di Private Chat!')
...
Doro.sendMessage(m.chat, { image: { url: cvnya.img }, caption: `${byr}` }, { quoted: m })
break
}
case 'topup':{
const sections = [
...
let inina = await Doro.sendMessage(m.chat, { image: { url: anuni.qr_payment }, caption: `${suksess}` }, { quoted: m })
setTimeout(() => {
Doro.sendMessage(m.chat, { delete:inina.key })
}, 500000)
break
case prefix+'mls':{
...
if(`${data.status}` == 200) {
Doro.sendButtonText(m.chat, buttons, `*── 「 CHECK ID OTOMATIS 」 ──*
...
Jika Data Sudah Benar Silahkan Klik Lanjutkan Dan Jika Data Salah Silahkan Mengetik Ulang Transaksi Anda!.`, Doro.user.name, m)
...
let kirimk = await Doro.sendMessage(m.chat, { image: { url: res2.data.data.elisaConfig.qrCode }, caption: `${suksess}` }, { quoted: m })
setTimeout(() => {
Doro.sendMessage(m.chat, { delete:kirimk.key })
}, 500000)
}
...
case 'order':
			case 'caraorder': {
				...
				Doro.sendMessage(m.chat, {text: capp}, {quoted:m})
				}
				break
...
const sendMsg = await Doro.sendMessage(m.chat, listMessage)
               break
					}
...
case 'confirmorderkunci': { //KUNCI = BIAR GA DIAKSES HEHE
				...
				if (feta.status == false) {
  				...
  				Doro.sendMessage(m.chat, {
    				caption: cap, image: {
      				url: feta.data.qris
    				}, buttons: buto, footer: `©Created Doro BOT`
  				})
				}
				console.log(feta)
				}
...
case 'listharga':
			...
			case 'pricelist': {
				...
				Doro.sendMessage(m.chat, {text: list}, {quoted:m})
				console.log(feta)
				}
				break*/
case 'chekstatus':
...
const sendMsg = await Doro.sendMessage(m.chat, listMessage)
        ...
        case 'additem':
            ...
            if (/image/.test(mime)) {
              let media = await Doro.downloadAndSaveMediaMessage(m.message.imageMessage || m.message.extendedTextMessage?.contextInfo.quotedMessage.imageMessage, 'image')
...
case 'proses':
            ...
            Doro.sendMessage(`6285737134572@s.whatsapp.net`, {text: proses })
            break
        case 'done':
            if (!isCreator) return
            ...
            Doro.sendMessage(`${args[1]}@s.whatsapp.net`, {text: sukses })
            break
case 'infogempa':
...
Doro.sendMessage(m.chat, { image: {url: anu}, caption: 'Done!'}, {quoted:m})
}
break
case 'sewabot':
m.reply(`*SEWA Doro BOT*
...
let buttons = [{ buttonId: 'menu', buttonText: { displayText: 'Menu' }, type: 1 }]
Doro.sendButtonText(m.chat, buttons, ucslm, creator)
}
break
case 'hai': {
...
Kalau Bingung Ketik #menu Atau Klik Button Ya!`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: 'Menu' }, type: 1 }]
Doro.sendButtonText(m.chat, buttons, hai, creator)
}
break
case 'hi': {
hai = `Hi Kak ${pushname}
...
Kalau Bingung Ketik #menu Atau Klik Button Ya!`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: 'Menu' }, type: 1 }]
Doro.sendButtonText(m.chat, buttons, halo, creator)
}
break
case 'sayang':{
...
Doro.sendMessage(m.chat, reactionMessage)
}
...
Doro.copyNForward(m.chat, msgs[budy.toLowerCase()], true)
}
}
